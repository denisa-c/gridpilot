...
- A working LaTeX distribution with the LNCS class
  ...
  paper builds.  A minimal `texlive-base + texlive-latex-recommended +
  texlive-fonts-recommended + texlive-bibtex-extra` install is
  sufficient.
...
```bash
# 1.1 Clone the public repo (or copy the EuroPar2026-GridPilot-Denisa
# folder from your local workstation):
git clone https://github.com/denisa-c/gridpilot.git EuroPar2026-GridPilot-Denisa
...
| `M100_ROOT` | `/Users/nisa/code/M100` | Enables step 0a |
...
cd /Users/<you>/path/to/EuroPar2026-GridPilot-Denisa
...
**Companion docs:** [`gridpilot/docs/INDEX.md`](gridpilot/docs/INDEX.md)
